...
<dl class="sub-nav">
	...
	<dd class="active" onclick="showMyRequests()"><a href="#">По пути</a></dd>
	<dd onclick=""><a href="#">Фильтр</a></dd>
</dl>
<h5><i class="fa fa-street-view"></i>&nbsp;&nbsp;Мои маршруты:</h5>
<div class="list_container" id="requests_list" style="height:410px;">
<?php
if(count($requests) == 0){
	echo '<p>Вы пока не добавили ни одного маршрута</p>';
}
...
?>
	<div class="row list_item hvr-left" id="list_item_<?php echo $request['request_id'];?>" onmouseover="highlightMark(this)" onmouseout="defaultMark(this)" onclick="showFinishMark(this)">
	  ...
	  <div class="small-9 columns" style="margin-left: 15px;">
		<h6>Мой маршрут<?php echo ' '.$request['index'];?></h6>
	  ...
	  <div class="small-12 columns">
		<h6> <?php echo $days_str;?> &nbsp;<i class="fa fa-clock-o"></i> <?php echo $time_str;?> &nbsp; | &nbsp; 
		  <a onclick="loadOnroadRoutes(<?php echo $request['request_id'];?>)"> Кто по пути? </a>
		</h6>
	  </div>
