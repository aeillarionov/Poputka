...
<h5><i class="fa fa-road"></i>&nbsp;&nbsp;Мои поездки: </h5>
<div class="list_container" id="routes_list" style="height:410px;">
<?php
if(count($routes) == 0){
	echo '<p>Вы пока не добавили ни одной поездки</p>';
}
	...
	<div class="row list_item hvr-left" id="list_item_<?php echo $route['route_id'];?>" onmouseover="highlightMark(this)" onmouseout="defaultMark(this)" onclick="showFinishMark(this)">
	  ...
	  <div class="small-12 columns">
		<h6> <?php echo $days_str;?> &nbsp;<i class="fa fa-clock-o"></i> <?php echo $time_str;?> &nbsp; | &nbsp; 
		  <a onclick="loadOnroadRequests(<?php echo $route['route_id'];?>)"> Кто по пути? </a>
		</h6>
	  </div>
